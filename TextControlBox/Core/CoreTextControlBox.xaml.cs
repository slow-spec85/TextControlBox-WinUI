...
internal sealed partial class CoreTextControlBox : UserControl
{
    ...
    public static readonly Dictionary<SyntaxHighlightID, SyntaxHighlightLanguage> SyntaxHighlightings =
        new Dictionary<SyntaxHighlightID, SyntaxHighlightLanguage>()
        {
            ...
            { SyntaxHighlightID.Go, new Go() },
            { SyntaxHighlightID.VisualBasic, new VisualBasic() },
            { SyntaxHighlightID.VBA, new Vba() },
            { SyntaxHighlightID.Bash, new Bash() },
            { SyntaxHighlightID.PowerShell, new PowerShell() },
            { SyntaxHighlightID.Rust, new Rust() },
            { SyntaxHighlightID.YAML, new Yaml() },
            { SyntaxHighlightID.Dockerfile, new Dockerfile() },
            { SyntaxHighlightID.HCL, new Hcl() },
